...
class ctrlusuarios extends CI_Controller {
    ...
    function imprimir(){
         ...
         foreach ($rows->result() as $row) {
            ...
            $pdf->Text(21,160,utf8_decode('Qué sería de la vida sin libros, ¿verdad?  Tal y como dijo Joseph Addison '));
            $pdf->Text(19,165,utf8_decode('"leer es para la mente lo que el ejercicio físico es para el cuerpo". '));
            $pdf->Text(19,170,utf8_decode('concentración y la empatía, agudiza los sentidos, reduce el estrés, mejora el sueño'));
